...
if($info){ //如果存在数据；
?>
<form action="templates/account_InsertSubmit.php" method="post" id="accountCopyForm" name="accountCopyForm">
<table align="center">
<tr><td colspan="2" align="center"><font size="+3">会计科目</font></td></tr>
<tr>
<td>ID（纯数字组成科目级次：4-2-2-2-2）</td><td><input name="id" type="text" maxlength="12" style="width:450px" value="<?php echo $info["id"]; ?>" required /></td>
</tr>
<tr>
...
$(function(){
	...
	$("#accountCopyForm").ajaxForm(options); 
});
// pre-submit callback 
